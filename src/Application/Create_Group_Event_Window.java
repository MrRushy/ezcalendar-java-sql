...
public class Create_Group_Event_Window {
	...
	/**
	 * This class is the 'Create Group Event Window', it pops up once the 'Create Event' button in 
	 ...
	 */ // If your confused about anything in this class, refer to 'Create_Event_Window', as it is practically identical
	
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Create_Group_Event_Window window = new Create_Group_Event_Window();
	...
	public Create_Group_Event_Window() { initialize(); }
	...
	public void eventTitleLBL() {
		JLabel eventTitleLBL = new JLabel("Event Title:");
		eventTitleLBL.setBounds(50, 44, 120, 18);
		eventTitleLBL.setFont(new Font("SansSerif",Font.BOLD, 15));	
	...
	// Creates User Name text field
		...
		public void addEventButton() {
			...
			addEventButton.setBounds(625, 180, 117, 29);
			...
			addEventButton.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					...
					Ez_Calendar_Controller.createGroupEvent(eventTitle, eventDesc, eventDate, eventStart, eventEnd, eventLocation);

					JOptionPane.showMessageDialog(frame, "Event added successfully!", "Success", JOptionPane.INFORMATION_MESSAGE);
					frame.dispose(); 
					View_Group_Calendar_Window GCW = new View_Group_Calendar_Window();
					GCW.initialize();
